...
impl fmt::Display for KeyCode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match self {
            ...
            // Emit plain Kanata key names for modifiers to keep simulator output machine-friendly.
            KeyCode::LCtrl => write!(f, "lctl"),
            KeyCode::RCtrl => write!(f, "rctl"),
            KeyCode::LShift => write!(f, "lsft"),
            KeyCode::RShift => write!(f, "rsft"),
            KeyCode::LAlt => write!(f, "lalt"),
            KeyCode::RAlt => write!(f, "ralt"),
            KeyCode::LGui => write!(f, "lmet"),
            KeyCode::RGui => write!(f, "rmet"),
